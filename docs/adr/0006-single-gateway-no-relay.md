...
[ADR-0022](0022-a-list-of-gateways.md) supersedes one sentence of this record and leaves the rest
exactly as it is.
...
replacing the gateway meant overwriting all of it. ADR-0022 keys every stored thing by a gateway id,
