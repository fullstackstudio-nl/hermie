// Vendored from NousResearch/hermes-agent apps/shared/src/gateway-events.ts @ b9c2660ca479d9a2cf000d1d45ac9aadd1b7e3bd (MIT).
 ...
 */
import type { BackendGatewayEventMap } from './gateway-contract.generated'

export * from './gateway-contract.generated'
...
export { GATEWAY_EVENT_TYPES as BACKEND_EVENT_NAMES } from './gateway-contract.generated'
