// Vendored from NousResearch/hermes-agent apps/shared/src/json-rpc-channel.test.ts @ b9c2660ca479d9a2cf000d1d45ac9aadd1b7e3bd (MIT).
// Generated by scripts/sync-hermes-shared.mjs — do not edit by hand.
import { describe, expect, it, vi } from 'vitest'

import { JsonRpcGatewayError, JsonRpcRequestChannel, type JsonRpcTransport } from './json-rpc-channel'
